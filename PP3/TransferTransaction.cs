...
public class TransferTransactions
{
    ...
    //execute rollback
    public void Execute(Account Fromaccount, Account Toaccount, decimal money)
    {
        _fromAccount = Fromaccount;
        _toAccount = Toaccount;
        _amount = money;
        ...
        if (_theWithdrawal.Execute(_fromAccount, _amount))
        {
            if (_theDeposit.Execute(_toAccount, _amount))
            {
                _theWithdrawal.RollBack(_fromAccount, _amount);
            }
        }
        _executed = true;
        _success = true;
    ...
    public void RollBack(Account Fromaccount,Account Toaccount, decimal money)
    {
        ...
        {
            _theDeposit.RollBack(_toAccount, _amount);
        }
    ...
    public void Print(decimal theMoney)
    {
        ...
        if (_success)
        {
            ...
            Console.WriteLine("The transaction was a success " + _amount + " was transfered from jakes account ");
