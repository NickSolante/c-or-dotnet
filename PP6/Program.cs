...
{
    addAccount, Deposit, Withdraw, Transfer, Print, PrintTransaction, Quit
}
...
public class Program
{
    ...
    public static void DoPrintHistory(Bank accounted)
    {
        accounted.PrintTranscationHistory();
    ...
    public static MethodOption ReadOption()
    {
        ...
        do
        {
            Console.WriteLine("Choose between the options of either 1 to Add an Account, 2 Deposit, 3 Withdrawal, 4 Transfer, 5 Print and 6 Transaction list and 7 for Quit");
        ...
        do
        {
            ...
            switch (ClientSelection)
            {
                ...
                case MethodOption.Print:
                    DoPrint(CommBank);
                    break;
                case MethodOption.PrintTransaction:
                    DoPrintHistory(CommBank);
                    break;
